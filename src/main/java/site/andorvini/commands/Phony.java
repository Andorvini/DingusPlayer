...
public class Phony {
    public static void phony(DiscordApi api, SlashCommandInteraction interaction, Optional<ServerVoiceChannel> optionalUserVoiceChannel, Player currentPlayer, Optional<ServerVoiceChannel> optionalBotVoiceChannel, Server interactionServer, ServerVoiceChannel userVoiceChannel, GreetingPlayer currentGreetingPlayer){
